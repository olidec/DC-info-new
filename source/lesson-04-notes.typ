...
#warnbox(
  ...
  [It is possible to write CSS directly inside an HTML tag using the
   ...
   maintain, and is explicitly penalized in the project rubric. All CSS
...
```html
<div>
  <img class="profile-photo" src="images/photo.jpg" alt="A photo of me">
...
unexpectedly. To prevent this, use `clear`:
...
Adding `clear: both` to the element that follows your floated image
tells the browser to start below any floats, restoring normal flow.
